...
class ModelEncrypterTest extends TestCase
{
    ...
    #[Test]
    public function encryptDelegatesToEncrypter(): void
    {
    ...
    #[Test]
    public function decryptWithUnserializeTrue(): void
    {
        $this->mockEncrypter->expects($this->once())
            ->method('decrypt')
            ->with('payload')
    ...
    #[Test]
    public function decryptWithUnserializeFalseAndSerializedValue(): void
    {
        $this->mockEncrypter->expects($this->once())
            ->method('decrypt')
            ->with('payload', false)
    ...
    #[Test]
    public function decryptWithUnserializeFalseAndNonSerializedValue(): void
    {
        $this->mockEncrypter->expects($this->once())
            ->method('decrypt')
            ->with('payload', false)
    ...
    #[Test]
    public function decryptWithUnserializeFalseAndSerializedFalseValue(): void
    {
        $this->mockEncrypter->expects($this->once())
            ->method('decrypt')
            ->with('payload', false)
    ...
    #[Test]
    public function getKeyDelegates(): void
    {
        $this->mockEncrypter->expects($this->once())
            ->method('getKey')
            ->willReturn('key123');
    ...
    #[Test]
    public function getPreviousKeysMergesWithDummy(): void
    {
    ...
    #[Test]
    public function getAllKeysMergesCurrentAndPrevious(): void
    {
        if (version_compare(Application::VERSION, '11.0.0', '<')) {
            $this->markTestSkipped('The test requires Laravel 11 or higher to run.');
        }
